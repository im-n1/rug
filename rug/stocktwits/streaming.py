...
class StreamListener(object):
    ...
    def on_disconnect(self, notice):
        """Called when stocktwits sends a disconnect notice

        Disconnect codes are listed here:
        https://developer.stocktwits.com/en/docs/tweets/filter-realtime/guides/streaming-message-types
        """
        return
...
class Stream(object):
    ...
    def __init__(self, auth, listener, **options):
        ...
        # values according to
        # https://developer.stocktwits.com/en/docs/tweets/filter-realtime/guides/connecting#reconnecting
    ...
    def _read_loop(self, resp):
        ...
        while self.running and not resp.raw.closed:
            ...
            #     break
            #
            # # read the next stocktwits status object
    ...
    def on_closed(self, resp):
        """ Called when the response has been closed by StockTwits """
        pass
